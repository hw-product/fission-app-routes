Rails.application.routes.draw do
  ...
  # Repository hooking
  get 'pipeline/repositories', :as => 'pipeline_repositories', :to => 'route_repositories#list'
  ...
  # Job display
  get 'pipeline/jobs(/:payload_filter/:payload_value)', :to => 'route_jobs#all', :as => 'pipeline_jobs'
